...
public class WebApiTests2 : IClassFixture<TestWebApplicationFactory<Program>>
{
    private readonly HttpClient _client;
    private readonly ITestOutputHelper _output;

    public WebApiTests2(TestWebApplicationFactory<Program> factory, ITestOutputHelper output)
    {
        _output = output;
